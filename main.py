            ...
            if "date" in text or "day" in text or "month" in text:
                ...
                speak = speak + "It's good to know that you are fine"
                            ...
                            if "chrome" in text.lower():
                                ...
                                os.startfile(
                                    r"C:\Users\SPANDAN\AppData\Local\Google\Chrome\Application\chrome.exe")

                            elif "word" in text.lower():
                                speak = speak + "Opening Microsoft Word"
                                os.startfile("Microsoft Word")
                                ...
                                os.startfile(
                                    r"C:\Users\SPANDAN\AppData\Local\Programs\Microsoft VS Code\Code.exe")
                            ...
                            elif "college website" in text.lower():
                                speak = speak + "Opening College Website"
                                webbrowser.open("http://www.frcrce.ac.in/")
                                ...
                                speak = speak + "Application not avaliable"
                ...
                img = r"C:\Users\SPANDAN\Documents\Wallpapers"
                ...
                music_dir = r"C:\Users\SPANDAN\Documents\songs"
